package app.shynline.jikanium.components
...
class GridAutoFitLayoutManager : GridLayoutManager {
    ...
    constructor(context: Context, columnWidth: Int = 0) : super(
        context,
        1
    ...
    private fun checkedColumnWidth(context: Context, _columnWidth: Int): Int {
